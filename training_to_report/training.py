...
'''
## train_data is a dataload object for faster loading of the data. composed of one-hot-encoded sequence and signals for each training chromosome
...
torch.save(model, '{}.troch'.format(TF_to_train,name)) 
