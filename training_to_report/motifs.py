...
TF_to_predict = input(' TF for motif discovery. "HES1", "HEYL", "MYOD1" or "MYOG".\n Multi not supported.\n Press "enter" to choose "HES1": ')
if TF_to_predict == '':
    TF_to_predict = 'HES1'
print('Using: ', TF_to_predict)

# load the one-hot-encoded sequence(s) and the attribitutions generated by 'attribitute.py' #
ohe = np.load('{}_report/{}_ohe.npz'.format(TF_to_predict,TF_to_predict))['arr_0']
attr = np.load('{}_report/{}_attr.npz'.format(TF_to_predict,TF_to_predict))['arr_0']
...
save_hdf5('{}_report/{}_motifs.hdf5'.format(TF_to_predict,TF_to_predict), pos, neg, window_size=1000)
