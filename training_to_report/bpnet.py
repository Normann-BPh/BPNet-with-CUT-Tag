...
# This is a slightly eddited version to accommodate the scheduler and saving training and validation loss of the profile.
...
class BPNet(torch.nn.Module):
	...
	def __init__(self, n_filters=64, n_layers=8, n_outputs=2, 
		...
		self.iconv = torch.nn.Conv1d(4, n_filters, kernel_size=20, padding=10)
